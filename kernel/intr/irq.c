    ...
    /// This installs the IRQ subsytem and allows us to use them
{
    ...
    // Master
    idt_set_gate(32, (size_t)_irq0, 0x08, 0x8E);
    idt_set_gate(33, (size_t)_irq1, 0x08, 0x8E);
    idt_set_gate(34, (size_t)_irq2, 0x08, 0x8E);
    idt_set_gate(35, (size_t)_irq3, 0x08, 0x8E);
    idt_set_gate(36, (size_t)_irq4, 0x08, 0x8E);
    idt_set_gate(37, (size_t)_irq5, 0x08, 0x8E);
    idt_set_gate(38, (size_t)_irq6, 0x08, 0x8E);
    idt_set_gate(39, (size_t)_irq7, 0x08, 0x8E);
    // Slave
    idt_set_gate(40, (size_t)_irq8, 0x08, 0x8E);
    idt_set_gate(41, (size_t)_irq9, 0x08, 0x8E);
    idt_set_gate(42, (size_t)_irq10, 0x08, 0x8E);
    idt_set_gate(43, (size_t)_irq11, 0x08, 0x8E);
    idt_set_gate(44, (size_t)_irq12, 0x08, 0x8E);
    idt_set_gate(45, (size_t)_irq13, 0x08, 0x8E);
    idt_set_gate(46, (size_t)_irq14, 0x08, 0x8E);
    idt_set_gate(47, (size_t)_irq15, 0x08, 0x8E);
}
