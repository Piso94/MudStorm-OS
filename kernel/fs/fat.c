...
void fat_umount()
{
	_MountInfo.numSectors     = 0;
	_MountInfo.fatOffset      = 0;
	_MountInfo.fatSize        = 0;
	_MountInfo.fatEntrySize   = 0;
	_MountInfo.numRootEntries = 0;
	_MountInfo.rootOffset     = 0;
	_MountInfo.rootSize       = 0;
}

void fat_uninstall()
{
	strcpy (_FSysFat.Name, NULL);
	_FSysFat.Directory = NULL;
	_FSysFat.Mount     = NULL;
	_FSysFat.Open      = NULL;
	_FSysFat.Read      = NULL;
	_FSysFat.Close     = NULL;
	...
	//! register ourself to volume manager
	volUnregisterFileSystem(&_FSysFat);
